...
* Aclararon procedimientos con los datos $NA, > LD, \leq LC$ :+1:
...
* La ciencia no es una simple colección de "hechos y números", es una herramienta cognitiva
...
* "La ciencia es _cómo_, no un _qué_, y mucho menos un _quién_" [Nogués 2018] {.r-fit}
...
## Publicaciones científicas en la era digital

* La revisión por pares ayuda a garantizar que la investigación publicada cumpla con los estándares mínimos de calidad científica
