...
data_rios <- data_rios %>%  dplyr::select ( !ends_with(c("_ld", "_lc"))) %>% 
...
data_articulo %>% filter (!(codigo_pto == "RN12" & fecha_muestra == "2018-04-17"| 
                            ...
                            codigo_pto == "RN3" & fecha_muestra == "2012-12-05"  ))   

# BBDD 3. Beretta data (99.5 out) -----------------------------------------

data_bereta <-data_articulo %>% filter (!(codigo_pto == "RN12" & fecha_muestra == "2018-04-17"| 
                                            codigo_pto == "RN5" & fecha_muestra == "2012-01-19" |
                                            codigo_pto == "RN5" & fecha_muestra == "2012-12-06" |
                                            codigo_pto == "RN6" & fecha_muestra == "2012-08-15" |
                                            codigo_pto == "RN3" & fecha_muestra == "2012-12-05"  ))   
